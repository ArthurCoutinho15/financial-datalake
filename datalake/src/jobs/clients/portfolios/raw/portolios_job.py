...
from .portfolios_table import RawPortfoliosTable
from clients.spark_client import spark_client


class RawPortfoliosJob:
    def __init__(self, date: date):
        self.date =  date
        self.table = RawPortfoliosTable()
        self.path = "/home/arthur/Arthur/Projetos/financial_pipeline/datalake/src/seeds/fake_data_portfolios.csv"
