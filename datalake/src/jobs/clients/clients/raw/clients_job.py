...
from .clients_table import RawClientTable
...
class RawClientsJob:
    def __init__(self, date: date):
        self.date =  date
        self.table = RawClientTable()
        self.path = "/home/arthur/Arthur/Projetos/financial_pipeline/datalake/src/seeds/fake_data_clients.csv"
